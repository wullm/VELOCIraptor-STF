...
// This function is fairly straightforward once you wrap your head around the bit math. We take apart the two bytes of
// the short parameter s with some simple bit math and then glue them back together in reverse order. If you understand
// bit shifts and bit ANDs, this should make perfect sense. As a companion to ShortSwap, we'll have ShortNoSwap, which is
// very simple:
...
// LongSwap is more or less the same idea as ShortSwap, but it switches around 4 bytes instead of 2. Again, this is
// straightforward bit math. Lastly, we need to be able to swap floats:
