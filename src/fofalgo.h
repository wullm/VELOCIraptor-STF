...
/// Similar to \ref FOFStream but also requires potential to be outlier value and both particles must be above threshold
/// param 9
...
/// checks to see if particles have positive types (useful for \ref GetVelocityDensity calculation with \ref STRUCDEN
/// flag)
