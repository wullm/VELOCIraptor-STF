 ...
 * hydro_ file containing information about the hydrodynamical properties of the cells (density, velocity,
 * pressure/gamma, then passive scalars like metallicity) part_ file containing information about number of dark
 * matter/star particles/sink (BH?) and their position/velocity info info_ file containing cosmological information
 */
